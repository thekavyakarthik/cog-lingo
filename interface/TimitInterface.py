...
class TimitInterface:
    def __init__(self, data_dir='./data', train_csv='./details/train_data.csv', test_csv='./details/test_data.csv'):
    ...
    def save_splits(self):
        with open("./interface/custom_train.json", "w") as f:
            json.dump(self.train, f)
        with open("./interface/custom_valid.json", "w") as f:
            json.dump(self.valid, f)
        with open("./interface/custom_test.json", "w") as f:
    ...
    def build_vocab(self):
        ...
        with open('./interface/phoneme.json', 'w') as vocab_file:
